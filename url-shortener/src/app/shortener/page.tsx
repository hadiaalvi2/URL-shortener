      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-5xl font-bold text-gray-900 mb-4">
            Create Your <span className="text-blue-600">Short Link</span>
          </h1>
          
        </div>

        {/* Main Form Card */}
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-gray-200/50 p-8 md:p-12 mb-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-3">
              <label htmlFor="url-input" className="block text-lg font-semibold text-gray-900">
                Enter your long URL
              </label>
              <div className="relative">
                <Input
                  ...
                  className="text-lg p-6 pr-32 rounded-2xl border-2 border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200"
                  required
                />
                <Button 
                  type="submit" 
        ...
        {/* Result Card */}
        {shortUrl && (
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl border border-gray-200/50 p-8 md:p-12 animate-in slide-in-from-bottom duration-500">
            <div className="text-center mb-8">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-2">Your Short Link is Ready!</h2>
              <p className="text-gray-600">Share it anywhere with beautiful previews</p>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 mb-8">
              <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex-1 min-w-0">
                  <label className="block text-sm font-medium text-gray-700 mb-2">Your shortened URL:</label>
                  <a
                    href={shortUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-600 hover:text-blue-700 text-lg font-medium break-all hover:underline transition-colors duration-200"
                  >
                    {shortUrl}
                  </a>
                </div>
            ...
            <div className="space-y-6">
              <div className="text-center">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Share Directly</h3>
                <p className="text-gray-600">Click to share your short link instantly</p>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                <div className="flex flex-col md:flex-row items-center justify-center gap-4">
                  <Button
                    ...
                    variant="outline"
                    className="px-6 py-3 rounded-xl font-semibold border-2 hover:border-blue-500 hover:text-blue-600 transition-all duration-200"
                  >
                    <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="px-6 py-3 rounded-xl font-semibold border-2 hover:border-green-500 hover:text-green-600 transition-all duration-200"
                  >
                    <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Features Preview */}
        {!shortUrl && (
          <div className="bg-white/60 backdrop-blur-sm rounded-3xl border border-gray-200/50 p-8 md:p-12">
