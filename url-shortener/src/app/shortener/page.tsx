...
export default function ShortenerPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Add to history
      addItem({
        originalUrl: data.metadata?.originalUrl || url,
  ...
  return (
    <div className="flex min-h-screen">
      {/* Main Content */}
      <div className={`flex-1 transition-all duration-300 ${sidebarCollapsed ? 'lg:pr-16' : 'lg:pr-80'}`}>
          ...
          <div className="max-w-4xl mx-auto relative z-10">
            ...
            <div className="text-center mb-12">
              <div className="flex items-center justify-between mb-6">
                <Link href="/" className="inline-flex items-center text-white hover:text-blue-200 group">
                ...
                <Button
                  ...
                  className="lg:hidden bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 text-white"
                >
